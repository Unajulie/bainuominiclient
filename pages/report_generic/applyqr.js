// pages/report_generic/applyqr.js
Page({
    ...
    checkqrinfo: function (e) {
        ...
        wx.request({
            ...
            complete: function (res) {
                ...
                wx.navigateTo({
                    url: "../report_generic/userform?qrid=" + res.data._id + "&phone="+res.data.phone+"&username=" + res.data.username+"&sex="+res.data.sex+"&idCard="+res.data.idCard+"&colldate="+res.data.colldate
                })
            }
        })
    },
        ...
        wx.showModal({
            ...
            success: function (res) {
                ...
                if (res.confirm) {
                    ...
                    data.username=oThis.data.username
                    wx.request({
                        url: "https://bainuo.beijingepidial.com/client/generic/deleteqrinfo",
                        header: {
                            "Content-Type": "application/x-www-form-urlencoded"
                        },
                        method: "POST",
    ...
    onLoad: function (options) {
        ...
        wx.getStorage({
            ...
            success: function (res) {
                ...
                //   wx.request({
                //     url: "https://bainuo.beijingepidial.com/client/generic/qrinfo",
                //     header: {
                //       "Content-Type": "application/x-www-form-urlencoded"
                //     },
                //     method: "POST",
