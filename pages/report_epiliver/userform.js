        ...
        if (!this.data.username) {
                ...
                checkqrinfo: function (e) {
                    ...
                    wx.request({
                        ...
                        complete: function (res) {
                            ...
                            wx.navigateTo({
                                url: "../report_epiliver/userform?qrid" + res.data.id + "&username=" + res.data.username
                            })
                        }
                    })
                },
            ...
            wx.getStorage({
                ...
                success: function (sessionuser) {
                    wx.request({
                        url: "https://bainuo.beijingepidial.com/client/user/liver/saveuser",
                        header: {
                            "Content-Type": "application/x-www-form-urlencoded"
                        },
                        method: "POST",
                        ...
                        complete: function (res) {
                            ...
                            if (res.data.status == "success") {
                                ...
                                wx.navigateTo({
                                    url:  '../report_epiliver/applyqr?qrid=' + res.data.id + "&username=" + oThis.data.username
                                })
                                )
                            } else {
                                oThis.setData({
                                ...
                                let url = '../report_epiliver/applyqr?qrid=' + res.data.id + "&username=" + oThis.data.username
                                console.info(url)
                                wx.navigateTo({
                                    url: url
                                })
