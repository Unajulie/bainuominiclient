Page({
        ...
        if (!this.data.sampleid) {
            ...
            wx.getStorage({
                ...
                success: function (res) {
                    ...
                    wx.request({
                        url: "https://bainuo.beijingepidial.com/client/liver/staff/saveuserinfo",
                        header: {
                            "Content-Type": "application/x-www-form-urlencoded"
                        },
                        method: "POST",
  ...
  uploadall: function (e) {
    ...
    wx.request({
        url: "https://bainuo.beijingepidial.com/client/liver/markmergedinfo",
        header: {
            "Content-Type": "application/x-www-form-urlencoded"
        },
        method: "POST",
    ...
    onLoad: function (options) {
        ...
        wx.getStorage({
            ...
            success: function (res) {
                ...
                wx.request({
                    url: "https://bainuo.beijingepidial.com/client/liver/unmergedlist",
                    header: {
                        "Content-Type": "application/x-www-form-urlencoded"
                    },
                    method: "POST",
