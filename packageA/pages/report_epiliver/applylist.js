        ...
        success: function (res) {
          wx.request({
            ...
            complete: function (res) {
              ...
              let url = '../report_epiliver/applyqr?qrid='+ res.data._id + "&username=" + that.data.username
              console.info(url)
              wx.navigateTo({
                  url: url
              })
      ...
      wx.getStorage({
          ...
          success: function (res) {
           ...
           oThis.setData({
            ...
            console.info(data)
            wx.request({
              url: "https://bainuo.beijingepidial.com/client/liver/applylist",
              header: {
                "Content-Type": "application/x-www-form-urlencoded"
              },
              method: "POST",
